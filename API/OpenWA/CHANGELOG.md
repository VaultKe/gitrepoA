...
- The group-list and status routes no longer appear twice in the OpenAPI contract under different path-parameter names; the parameters are now `sessionId` and `id`, and the URLs are unchanged.
