        ...
        <View style={{ flex: 1, paddingHorizontal: spacing.sm }}>
          ...
          >
            ...
            <FlatList
              ...
              contentContainerStyle={hook.filteredChamas.length === 0 ? { flexGrow: 1, justifyContent: 'center' } : undefined}
...
const renderEmptyState = (hook) => (
  <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.xxxl, paddingHorizontal: spacing.xl }}>
